...
def test_log_error_creates_log_file_in_testoutput():
    ...
    # Gebruik een aparte testoutput map
    ...
    # Controleer of de logregel de juiste info bevat
...
async def test_crawl_parallel_handles_exceptions():
    ...
    # Patch de AsyncWebCrawler zodat er geen echte requests worden gedaan
    with patch("Crawlscraper.AsyncWebCrawler") as MockCrawler:
        ...
        # Controleer of de fouten correct zijn gelogd
